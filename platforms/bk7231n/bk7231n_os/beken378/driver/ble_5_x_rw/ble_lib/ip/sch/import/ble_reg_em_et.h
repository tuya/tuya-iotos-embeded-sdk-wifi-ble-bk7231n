 ...
 * </pre>
 */
#define EM_BT_EXTAB_ADDR   (0x00910000 + EM_ET_OFFSET)
...
__INLINE void em_bt_extab_pack(int elt_idx, uint8_t schprio1, uint8_t spa, uint8_t csb, uint8_t sniff, uint8_t rsvd, uint8_t esco, uint8_t status, uint8_t mode)
{
    ...
    BLE_ASSERT_ERR((((uint16_t)csb << 9) & ~((uint16_t)0x00000200)) == 0);
    BLE_ASSERT_ERR((((uint16_t)sniff << 8) & ~((uint16_t)0x00000100)) == 0);
    BLE_ASSERT_ERR((((uint16_t)rsvd << 7) & ~((uint16_t)0x00000080)) == 0);
    BLE_ASSERT_ERR((((uint16_t)esco << 6) & ~((uint16_t)0x00000040)) == 0);
 ...
 * </pre>
 */
#define EM_LE_EXTAB_ADDR   (0x00910000 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_RAWSTP0_ADDR   (0x00910002 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_RAWSTP1_ADDR   (0x00910004 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_FINESTP_ADDR   (0x00910006 + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_CSPTR_ADDR   (0x00910008 + EM_ET_OFFSET)
...
__INLINE uint16_t em_csptr_getf(int elt_idx)
{
    ...
    BLE_ASSERT_ERR((localVal & ~((uint16_t)0x00007FFF)) == 0);
    return (localVal >> 0);
}

__INLINE void em_csptr_setf(int elt_idx, uint16_t csptr)
{
    BLE_ASSERT_ERR((((uint16_t)csptr << 0) & ~((uint16_t)0x00007FFF)) == 0);
...
{
    BLE_ASSERT_ERR((((uint16_t)priobwunit << 15) & ~((uint16_t)0x00008000)) == 0);
    BLE_ASSERT_ERR((((uint16_t)priobw << 0) & ~((uint16_t)0x00007FFF)) == 0);
 ...
 * </pre>
 */
#define EM_PRIOLVL_ADDR   (0x0091000C + EM_ET_OFFSET)
 ...
 * </pre>
 */
#define EM_PTI_VXCHAN_ADDR   (0x0091000E + EM_ET_OFFSET)
...
__INLINE void em_pti_vxchan_pack(int elt_idx, uint8_t ptiprio, uint8_t vxchan)
{
    ...
    BLE_ASSERT_ERR((((uint16_t)vxchan << 0) & ~((uint16_t)0x00000003)) == 0);
