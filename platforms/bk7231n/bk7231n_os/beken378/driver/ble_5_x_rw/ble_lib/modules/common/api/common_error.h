 ...
 *****************************************************/
    ...
    COMMON_ERROR_CON_ALREADY_EXISTS              = 0x0B,
    ...
    COMMON_ERROR_SCO_OFFSET_REJECTED             = 0x1B,
    COMMON_ERROR_SCO_INTERVAL_REJECTED           = 0x1C,
    COMMON_ERROR_SCO_AIR_MODE_REJECTED           = 0x1D,
    ...
    COMMON_ERROR_UNACCEPTABLE_CONN_PARAM         = 0x3B,
    COMMON_ERROR_ADV_TO                          = 0x3C,
    COMMON_ERROR_TERMINATED_MIC_FAILURE          = 0x3D,
    COMMON_ERROR_CONN_FAILED_TO_BE_EST           = 0x3E,
    COMMON_ERROR_CCA_REJ_USE_CLOCK_DRAG          = 0x40,
    COMMON_ERROR_TYPE0_SUBMAP_NOT_DEFINED        = 0x41,
    COMMON_ERROR_UNKNOWN_ADVERTISING_ID          = 0x42,
    COMMON_ERROR_LIMIT_REACHED                   = 0x43,
    COMMON_ERROR_OPERATION_CANCELED_BY_HOST      = 0x44,
    COMMON_ERROR_PKT_TOO_LONG                    = 0x45,
