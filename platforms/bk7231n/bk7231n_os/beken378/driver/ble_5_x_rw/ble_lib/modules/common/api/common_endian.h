 ...
 ****************************************************************************************
 */
__INLINE void common_bswap(uint8_t* p_val_out, const uint8_t* p_val_in, uint16_t len)
{
    while (len > 0)
    {
        len--;
 ...
 ****************************************************************************************
 */
__INLINE uint32_t common_bswap24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__INLINE uint32_t common_hton24(uint32_t host24)
{
    #if (!CPU_LE)
        return host24;
    #else
        return common_bswap24(host24);
    #endif // CPU_LE
}
 ...
 ****************************************************************************************
 */
__INLINE uint32_t common_ntoh24(uint32_t val24)
{
    return common_hton24(val24);
}
 ...
 ****************************************************************************************
 */
__INLINE uint32_t common_htob24(uint32_t val24)
{
    #if (CPU_LE)
        return val24;
    #else
 ...
 ****************************************************************************************
 */
__INLINE uint32_t common_btoh24(uint32_t val24)
{
    return common_htob24(val24);
}
