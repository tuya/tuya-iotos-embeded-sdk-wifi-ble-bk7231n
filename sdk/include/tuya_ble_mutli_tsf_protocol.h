...
***********************************************************/
__MUTLI_TSF_PROTOCOL_EXT \
OPERATE_RET klvlist_2_data(klv_node_s *list,uint8_t **data,uint32_t *len,uint8_t type);
...
***********************************************************/
__MUTLI_TSF_PROTOCOL_EXT \
OPERATE_RET data_2_klvlist(uint8_t *data,uint32_t len,klv_node_s **list,uint8_t type);
...
***********************************************************/
__MUTLI_TSF_PROTOCOL_EXT \
OPERATE_RET trsmitr_send_pkg_encode(frm_trsmitr_proc_s *frm_trsmitr, unsigned char version, unsigned char *buf, unsigned int len);
...
***********************************************************/
__MUTLI_TSF_PROTOCOL_EXT \
OPERATE_RET trsmitr_recv_pkg_decode(frm_trsmitr_proc_s *frm_trsmitr, uint8_t *raw_data, uint8_t raw_data_len);
