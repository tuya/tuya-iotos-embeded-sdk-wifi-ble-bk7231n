...
TARGET_PLATFORM_REPO=https://airtake-public-data-1254153901.cos.ap-shanghai.myqcloud.com/smart/embed/pruduct/bk7231n_0.0.2.zip
TARGET_PLATFORM_VERSION=0.0.2
ROOT_DIR=$(pwd)
